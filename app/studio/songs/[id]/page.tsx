      ...
      <div className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
        <div className="space-y-6">
          <div className="rounded-[2rem] border border-violet-300/15 bg-white/[0.04] p-8 shadow-[0_24px_90px_rgba(109,40,217,0.18)] backdrop-blur-xl">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="rounded-[2rem] bg-violet-500/12 px-4 py-3 text-sm font-semibold text-[#D7E6FF]">
                {song.genre}
              </div>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="rounded-[1.75rem] bg-[#0A0B1B]/95 p-5 text-sm text-[#D7E6FF]">
                <p className="text-xs uppercase tracking-[0.3em] text-violet-200">Artist</p>
                <p className="mt-3 text-lg font-semibold text-white">{song.artist}</p>
              </div>
              <div className="rounded-[1.75rem] bg-[#0A0B1B]/95 p-5 text-sm text-[#D7E6FF]">
                <p className="text-xs uppercase tracking-[0.3em] text-violet-200">Upload date</p>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              {[
                ...
                <div key={item} className="rounded-[1.75rem] bg-[#0A0B1B]/95 p-4 text-sm text-[#D7E6FF]">
                  {item}
                </div>
              ))}
            </div>
          ...
          <div className="rounded-[2rem] border border-violet-300/15 bg-black/60 p-8 shadow-[0_24px_90px_rgba(109,40,217,0.2)] backdrop-blur-xl">
            <div className="grid gap-6 lg:grid-cols-[1fr_0.9fr]">
              ...
              <div className="rounded-[1.75rem] bg-[#0A0B1B]/95 p-6 text-sm text-[#D7E6FF]">
                <p className="text-xs uppercase tracking-[0.3em] text-violet-200">Collaborators</p>
                <p className="mt-3 text-lg font-semibold text-white">{song.collaborators}</p>
              </div>
            </div>
            <div className="mt-8 space-y-5">
              <div className="rounded-[1.75rem] bg-[#0A0B1B]/95 p-5">
                <p className="text-sm uppercase tracking-[0.3em] text-violet-200">Release readiness</p>
                <div className="mt-4 h-3 overflow-hidden rounded-full bg-white/10">
                  <div className="h-full rounded-full bg-gradient-to-r from-violet-400 via-fuchsia-400 to-cyan-300" style={{ width: `${song.status === 'released' ? 100 : song.status === 'mastering' ? 75 : song.status === 'mixing' ? 55 : song.status === 'in progress' ? 35 : 20}%` }} />
                </div>
              </div>
              <div className="rounded-[1.75rem] bg-[#0A0B1B]/95 p-5">
                <p className="text-sm uppercase tracking-[0.3em] text-violet-200">AI manager suggestions</p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {['Build release plan', 'Start campaign', 'Draft outreach', 'Move to release'].map((label) => (
                <PrototypeAction
                  ...
                  className="rounded-full bg-gradient-to-br from-violet-400 via-indigo-500 to-cyan-300 px-5 py-3 text-sm font-semibold text-white transition hover:brightness-110"
                />
              ))}
            </div>
          </div>
        ...
        <aside className="space-y-6">
          <div className="rounded-[2rem] border border-violet-300/15 bg-[#0A0B1B]/95 p-6 shadow-[0_24px_90px_rgba(109,40,217,0.18)] backdrop-blur-xl">
            <p className="text-sm uppercase tracking-[0.3em] text-violet-200">Artwork</p>
          ...
          <div className="rounded-[2rem] border border-violet-300/15 bg-black/60 p-6 shadow-[0_24px_90px_rgba(109,40,217,0.2)] backdrop-blur-xl">
            <p className="text-sm uppercase tracking-[0.3em] text-violet-200">Campaign quick view</p>
